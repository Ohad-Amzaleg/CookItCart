...
const validatePassword = password => {
	...
	return reLength.test(password) && reSpcialChar.test(password) && reUpperCase.test(password);
};

//########################## Verification ##########################
const sendVerificationEmail = async (email, transporter, userOTPVerification) => {
